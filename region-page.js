/* ============================================================
   ...
   Each region page Code Block sets window.BSF_REGION before
   loading this script.

   To update all region pages at once:
   1. Edit this file and push to GitHub
   2. Purge: https://purge.jsdelivr.net/gh/basofu/basofu-assets@main/region-page.js
   ============================================================ */
...
const COMPETITION_TYPE = {
  ...
  const container      = document.getElementById("basofu-league-container");
  const seasonSelect   = document.getElementById("basofu-season-select");
  const tabsContainer  = document.getElementById("basofu-competition-tabs");
